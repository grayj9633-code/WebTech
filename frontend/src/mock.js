// Mock data for WebTech Portfolio

export const mockData = {
  hero: {
    headline: "Building Powerful Websites & Apps That Drive Results",
    subheadline: "Transforming ideas into digital experiences with cutting-edge technology",
    ctaButtons: [
      { text: "View My Work", link: "#projects", primary: true },
  ...
  projects: [
    ...
    {
      id: 2,
      title: "Bird Speed Delivery",
      description: "A fast delivery service platform",
